...
public class ReflectionUtils {
    ...
    public static List<Class<?>> getClasses(File dir, String pk, String[] outsides) throws ClassNotFoundException {
        ...
        String thisPk = org.apache.commons.lang3.StringUtils.isBlank(pk) ? "" : pk + ".";
        for (File f : dir.listFiles()) {
            ...
            if (name.endsWith(".class")) {
                ...
                if (outsides == null || outsides.length == 0 || !org.apache.commons.lang3.ArrayUtils.contains(outsides, clazzName)) {
                    try {
    ...
    public static String getSimpleSurname(Class<?> clazz) {
        ...
        return org.apache.commons.lang3.StringUtils.substringBefore(clazz.getSimpleName(), "_$$_");
    }
    ...
    public static String getSurname(Class<?> clazz) {
        ...
        return org.apache.commons.lang3.StringUtils.substringBefore(clazz.getName(), "_$$_");
    }
